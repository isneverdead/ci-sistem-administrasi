...
<div class="w-full shadow-lg rounded-lg px-5 pt-5 flex flex-col h-full bg-white mb-4 overflow-y-scroll">
  <div class="flex w-full justify-center">
    <h1 class="fonst-sans font-bold text-2xl text-gray-800 mb-5">Tambah berita</h1>
  </div>
  <form action="<?= base_url('/dashboard/informasi/add/save') ?>" method="post">
    <!-- error message -->
    ...
    <div class="w-full flex flex-row border-2 rounded-lg border-green-200">
      ...
      <div class="w-full overflow-hidden rounded-lg px-2 py-1">
        <input id="title" class="w-full focus:outline-none" type="text" placeholder="Masukkan judul" name="title" value="<?= set_value('title'); ?>" />
      </div>
    </div>
    ...
    <!-- input berita  -->
    <div class="w-full   flex flex-col border-2 rounded-lg border-green-200">
      <!-- <div class="px-2 lg:px-5 flex items-center w-32 bg-green-200 mr-5">
        <h1 class="font-sans text-md md:text-xl font-semibold text-gray-800">Jumlah</h1>
      </div> -->
      <div class="w-full  overflow-hidden rounded-lg px-2 py-1">
      <textarea class="w-full focus:outline-none" id="description" name="description" rows="10" ></textarea>

        <!-- <input id="description" class="w-full focus:outline-none" type="textarea" placeholder="Masukkan berita" name="description" value="<?= set_value('description'); ?>" /> -->
      </div>
    </div>
