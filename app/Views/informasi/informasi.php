...
<?php if (!empty(session()->getFlashData('fail'))) : ?>
  ...
  <div class="w-full flex flex-row px-5 mt-10 mb-5 items-center justify-between">
    <h1 class="fonst-sans font-bold text-2xl text-gray-800 mb-5">Informasi</h1>
    <a class=" <?= ($user_info['email'] == 'admin@admin.com')?'': 'hidden'?>" href="<?= base_url('/dashboard/informasi/add')?>">
  ...
  <table class="text-left w-full border-collapse">
    ...
    <thead class="">
      <tr>
        <th class="py-4 px-6 font-bold uppercase text-sm text-grey-800 border-b">Judul</th>
        <th class="py-4 px-6 font-bold uppercase text-sm text-grey-800 border-b">Kategori</th>
    ...
    <tbody>
      ...
      <tr class="hover:bg-green-100 transition duration-200">
        <td class="py-4 px-6 border-b border-grey-light"><?= $berita['title']; ?></td>
        <td class="py-4 px-6 border-b border-grey-light"><?= $berita['tag']; ?></td>
        ...
        <td class="py-4 px-6 border-b border-grey-light <?= ($user_info['email'] == 'admin@admin.com')?'': 'hidden'?>">
          <a href="<?= base_url('/dashboard/informasi/edit')?>/<?= $berita['id']?>">
