...
<body class="h-screen overflow-hidden flex items-center justify-center" style="background: #edf2f7;">
    ...
    <div class="px-6 py-8">
        <div class="container flex justify-between mx-auto overflow-y-scroll h-screen">
            <div class="w-full lg:w-8/12 overflow-y-scroll">
                <div class="flex items-center justify-between">
                ...
                <div class="mt-6">
                    <div class="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md overflow-y-scroll">
