        ...
        <div class="w-full h-full flex flex-col py-10 justify-between">
          <form action="<?= base_url('/auth/in') ?>" method="post">
            ...
            <div class="
                  ...
                  mt-2
                ">
              <input id="email" class="w-full focus:outline-none" type="text" placeholder="Masukkan Email" name="email" />
            </div>
            ...
            <div class="
                  ...
                  mt-2
                ">
              <input id="password" class="w-full focus:outline-none" type="password" placeholder="Masukkan Password" name="password" />
            </div>
            <h5 class="font-sans text-red-500 mb-2"><?= isset($validation) ? display_error($validation, 'password') : '<br/>' ?></h5>
