...
<html lang="en">
  ...
  <body class="bg-gray-100">
    <div class="flex flex-col w-full h-screen px-5 py-16 xs:py-32 lg:p-20 items-center justify-center">
      <!-- card -->
      <div class="w-full h-full flex flex-row rounded-2xl overflow-hidden shadow-2xl">
        ...
        <!-- login section  -->
        <div class="flex flex-col w-full items-center md:w-1/2 py-2 xs:py-5 px-5 md:px-20 bg-white">
          <div class="w-full h-full flex flex-col py-5 justify-between">
            <form action="<?= base_url('/auth/add') ?>" method="post">
              <?= csrf_field(); ?>
              <!-- <h1 class="font-semibold text-gray-800 text-6xl mb-5 font-sans">Register</h1> -->
              <h1 class="font-semibold text-gray-800 text-6xl mb-5 font-sans">Daftar</h1>
              ...
              <h5 class="font-sans text-red-500">
                <?= isset($validation) ? display_error($validation, 'name') : '<br/>' ?>
              </h5>
              ...
              <h5 class="font-sans text-red-500 mb-2">
                <?= isset($validation) ? display_error($validation, 'confirm_password') : '<br/>' ?>
              </h5>
