...
class Mahasiswa extends Controller
{
	...
	public function index()
	{
		...
		echo view('mahasiswa/mahasiswa_aktif');
...
<?php
	...
	public function edit_save($id = null)
	{
		...
		if (!$query) {
			...
			return redirect()->to('dashboard/anggota/add')->with('success', 'Anggota berhasil Diedit');
		}
	}
	...
	public function delete($id)
	{
		...
		if (!$query) {
			...
			return redirect()->to('dashboard/anggota/add')->with('fail', 'Anggota berhasil Dihapus');
		}
	}
}
